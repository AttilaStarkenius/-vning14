...
namespace Övning14.Controllers
{
    public class GymClassesController : Controller
    {
        ...
        public async Task<IActionResult> BookingToogle(int? id)
        {
            ...
            List<ApplicationUserGymClass> AttendingMembers = new List<ApplicationUserGymClass>();
            foreach (var attendingMember in _context.GymClasses)
            {
                //AttendingMembers.Add(attendingMember);

            }
            //public ICollection<ApplicationUserGymClass> AttendingMembers = new ICollection<ApplicationUserGymClass>();

            //_userManager.Users.Select(u => u.Id).Where(u.Id == id);

            return View();
            //_userManager.FindByNameAsync(User.Identity.Name);  
        }
